...
EOFontIconCSS;
	...
	function js_load_scripts () {
		...
		wp_localize_script('bpfb_interface_script', 'l10nBpfb', array(
			'add_photos' => __('Publicar', 'bpfb'),
			'add_remote_image' => __('Agregar URL de imagen', 'bpfb'),
			'add_another_remote_image' => __('Agregar otra URL de la imagen', 'bpfb'),
			'add_videos' => __('Agregar videos', 'bpfb'),
			'add_video' => __('Agregar video', 'bpfb'),
			'add_links' => __('Agregar Vínculos', 'bpfb'),
			'add_link' => __('Agregar Vínculo', 'bpfb'),
			'add' => __('Add', 'bpfb'),
			'cancel' => __('Cancelar', 'bpfb'),
			'preview' => __('previsualizar', 'bpfb'),
			'drop_files' => __('Arrastrar los archivos aquí', 'bpfb'),
			'upload_file' => __('Subir imagen', 'bpfb'),
			'choose_thumbnail' => __('Seleccionar miniatura', 'bpfb'),
			'no_thumbnail' => __('', 'bpfb'),
			'paste_video_url' => __('Pegar url del video', 'bpfb'),
			'paste_link_url' => __('Pegar vínculo aquí', 'bpfb'),
			'images_limit_exceeded' => sprintf(__("Agregaste demasiadas imágenes, solo %d serán publicas.", 'bpfb'), BPFB_IMAGE_LIMIT),
			// Variables
