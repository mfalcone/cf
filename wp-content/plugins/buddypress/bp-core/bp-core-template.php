...
function bp_search_form_type_select() {
	...
	if ( bp_is_active( 'xprofile' ) ) {
		$options['members'] = _x( 'Miembros', 'search form', 'buddypress' );
	}

	if ( bp_is_active( 'groups' ) ) {
		$options['groups']  = _x( 'Grupos', 'search form', 'buddypress' );
	}
	...
	$selection_box  = '<label for="search-which" class="accessibly-hidden">' . _x( 'Filtrar por:', 'search form', 'buddypress' ) . '</label>';
