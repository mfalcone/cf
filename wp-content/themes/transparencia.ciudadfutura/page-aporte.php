...
<div class="container" id="contact_form">
	...
	<!--glyphicon glyphicon-unchecked  glyphicon glyphicon-check-->
		<li> <span class="glyphicon glyphicon-unchecked"></span> $100 </li>
		<li> <span class="glyphicon glyphicon-unchecked"></span> $200 </li>
		<li> <span class="glyphicon glyphicon-unchecked"></span> $500 </li>
		<li id="otro"> <span class="glyphicon glyphicon-unchecked"></span> otro <input type="text" id="otro_input"></li>
	</ul>
