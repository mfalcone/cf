...
$sDestDir = '\\hmfsw\web\DTC001\ciudadfutura.com.ar\public_html';
if ( substr($sDestDir, 0, 1) == "\\" ) {
      $sDestDir = "\\".$sDestDir ;
}
define( 'WPCACHEHOME', '\\hmfsw\web\DTC001\ciudadfutura.com.ar\public_html/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager

/** El nombre de tu base de datos de WordPress */
define('DB_NAME', 'futura_wp');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'futura_wp');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'mJ4WACfnjv');
...
define('DOMAIN_CURRENT_SITE', 'ciudadfutura.com.ar');
